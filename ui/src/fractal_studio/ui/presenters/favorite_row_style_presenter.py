        ...
        *,
        ...
        if selected:
            ...
            thumb_label.setStyleSheet(
                f"border: 2px solid {theme.selected_border}; border-radius: 3px;"
            )
            ...
            thumb_label.setStyleSheet(
                f"border: 2px solid {theme.hover_border}; border-radius: 3px;"
            )
            name_label.setStyleSheet("")
        else:
            row.setStyleSheet(
                "border-radius: 4px; border-left: 4px solid transparent; background-color: transparent;"
            )
            thumb_label.setStyleSheet(
